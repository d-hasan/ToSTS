...
from trip_samples_generator import TripSamplesGenerator 
...
parser.add_argument('--trip-planner-config', type=str, default='trip_samples_generator.cfg', help='to change default trip planner config file')
...
if __name__ == '__main__':
    ...
    trip_planner = TripSamplesGenerator(trip_planner_config, sim_net, tts_data.od_counts, traffic_regions, region_graph)
    print('Initialized Trip Planner.\n')

    from trip_sampler import TripSampler
    trip_sampler_config = 'configs/trip_sampler.cfg'
    trip_sampler = TripSampler(trip_sampler_config)
